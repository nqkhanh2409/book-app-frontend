...
const Order = () => {
  ...
  if (isError) return <div>Error while getting orders</div>;
    ...
    <div className="container mx-auto p-6">
      ...
      {orders.length === 0 ? (
        ...
        orders.map((order, index) => (
          <div key={index} className="bg-white rounded shadow-lg p-4">
            <div key={order._id} className="border-b mb-4"></div># {index + 1}
